        ...
        try {
            ...
            try {
                ...
                if (dbUser.loginMethod === 'google') {
                    ...
                    // In the Login component, replace the unverified email section with this:
                    ...
                    // ✅ SEND VERIFICATION CODE AUTOMATICALLY (same as signup)
                    console.log('📧 Attempting to send verification code...');
                    console.log('Email:', email);
                    console.log('UserName:', dbUser.name);

                    try {
                        console.log('🚀 Making POST request to /send-verification-code');
                        ...
                        console.log('✅ Response received:', codeResponse);
                        console.log('✅ Response data:', codeResponse.data);
                        ...
                        console.error('❌ Error config:', emailError.config);
                    }

                    console.log('📱 About to show SweetAlert');

                    // Show alert after sending code
                    await Swal.fire({
                        icon: 'warning',
